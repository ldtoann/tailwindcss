...
const Bycategory = ({ params }) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8000/categories/` + id + `/products`)
                          ...
                          categories.map((category) => (
                            <li key={category.name}>
                              <a
                                ...
                                className="no-underline text-black font-semibold block px-2 py-3"
                              >
                                {category.name}
                              </a>
                            </li>
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                <form className="hidden lg:block">
                  ...
                  <ul
                    role="list"
                    className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900 pl-0"
                  >
                    {categories &&
                      categories.map((category) => (
                        <li key={category.name}>
                ...
                <div className="lg:col-span-3">
                  <div className="bg-white">
                    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-2 sm:py-3 lg:max-w-7xl lg:px-8">
                      <StyledCard>
